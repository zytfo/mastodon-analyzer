...
const Home = () => {
    return (
        <div>
            <h1>Leveraging Large Language Models to Identify Disinformation on Mastodon</h1>
            <div>
                {/*<h2><a href="http<h2>Authors: <a href="https://github.com/zytfo/">Artur Khaialiev</a>, <a*/}
                {/*    href="https://ufind.univie.ac.at/de/person.html?id=19954">Paul Fuxjäger</a></h2>s://github.com/zytfo/mastodon-analyzer">Github Repository</a></h2>*/}
                {/**/}
