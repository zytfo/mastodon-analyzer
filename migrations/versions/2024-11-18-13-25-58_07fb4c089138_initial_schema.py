...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("quotes_count", sa.Integer(), nullable=True, comment="Quotes Count"),
        sa.Column("quote", sa.String(), nullable=True, comment="Quote"),
        sa.Column("quote_approval", sa.String(), nullable=True, comment="Quote Approval"),
    ...
    op.create_table(
        ...
        sa.Column("openai_response", sa.Text(), nullable=True, comment="OpenAI Response"),
        sa.Column("openai_confidence", sa.Float(), nullable=True, comment="OpenAI Confidence"),
        sa.Column("openai_is_suspicious", sa.Boolean(), nullable=True, comment="OpenAI Is Suspicious"),
        sa.Column("claude_response", sa.Text(), nullable=True, comment="Claude Response"),
        sa.Column("claude_confidence", sa.Float(), nullable=True, comment="Claude Confidence"),
        sa.Column("claude_is_suspicious", sa.Boolean(), nullable=True, comment="Claude Is Suspicious"),
        sa.Column("gemini_response", sa.Text(), nullable=True, comment="Gemini Response"),
        sa.Column("gemini_confidence", sa.Float(), nullable=True, comment="Gemini Confidence"),
        sa.Column("gemini_is_suspicious", sa.Boolean(), nullable=True, comment="Gemini Is Suspicious"),
        sa.Column("llama_response", sa.Text(), nullable=True, comment="Llama Response"),
        sa.Column("llama_confidence", sa.Float(), nullable=True, comment="Llama Confidence"),
        sa.Column("llama_is_suspicious", sa.Boolean(), nullable=True, comment="Llama Is Suspicious"),
        sa.Column("checked_at", sa.DateTime(), nullable=True, comment="Checked At"),
